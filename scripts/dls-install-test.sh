...
helm upgrade --install test-argocd-monitor oci://ghcr.io/epics-containers/charts/argocd-monitor \
    ...
    --set oauth2Proxy.existingSecret=test-argocd-monitor-oauth2 \
    --set ingress.enabled=true \
    --set ingress.host=test-argocd-monitor.diamond.ac.uk \
    ...
    --set 'oauth2Proxy.extraArgs[1]=--redirect-url=https://test-argocd-monitor.diamond.ac.uk/oauth2/callback' \
